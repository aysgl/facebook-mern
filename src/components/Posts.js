...
const Posts = () => {
    ...
    return (
        <div>
            {postsData.map(i =>
                <div className='bg-dark rounded mb-3'>
                    <div className='p-3 d-flex justify-content-between align-items-center'>
                        <div className='username d-flex align-items-center'>
                            ...
                            <div className='ms-2'>
                                ...
                                <p className='mb-0 small text-light'>Senin için öneriliyor · 1g · <IconEarth /> </p>
                    ...
                    <div>
                        ...
                        <div className='mx-3 py-2 d-flex justify-content-between border-bottom'>
                            <Emotions emotion={i.emotions} count={totalEmotions[i.emotions] || 0} />
                        ...
                        <div className='emotion-wrapper px-3 py-1 d-flex justify-content-between'>
                            <button onMouseOver={() => setShowEmoji(true)} onMouseOut={() => setShowEmoji(false)} className='show-emoji btn btn-dark w-100 d-flex align-items-center justify-content-center'>
                                <IconLike />
                                Beğen
                            ...
                            <button onMouseOver={() => setShowComment(true)} className='btn btn-dark w-100 d-flex align-items-center justify-content-center'>
                                <IconComment />
                                Yorum Yap
                            </button>
                            ...
                            <div class="dropdown">
                                <button className='btn btn-dark w-100 d-flex align-items-center justify-content-center dropdown-toggle' type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <IconShare />
                                    Paylaş
                                </button>
