            ...
            <nav className="navbar navbar-expand-sm bg-body-tertiary p-0 border-bottom fixed-top">
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav mx-auto">
                        ...
                        <li className='nav-item'>
                            <a className="nav-link">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M3.25 2.75a1.25 1.25 0 1 0 0 2.5h17.5a1.25 1.25 0 1 0 0-2.5H3.25zM2 12c0-.69.56-1.25 1.25-1.25h17.5a1.25 1.25 0 1 1 0 2.5H3.25C2.56 13.25 2 12.69 2 12zm0 8c0-.69.56-1.25 1.25-1.25h17.5a1.25 1.25 0 1 1 0 2.5H3.25C2.56 21.25 2 20.69 2 20z"></path></svg>
                            </a>
                        </li>
                    </ul>

                    <ul className="navbar-nav ms-auto">
                        <li className='nav-item bg-secondary rounded-pill me-2'>
                            <a className='nav-link '>
                                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M11 19a1 1 0 1 0 2 0v-6h6a1 1 0 1 0 0-2h-6V5a1 1 0 1 0-2 0v6H5a1 1 0 1 0 0 2h6v6z"></path></svg>
                            </a>
                        </li>
                        ...
                        <li className='nav-item bg-secondary rounded-pill'>
                            <a className='nav-link'>
                                <Avatar url={"https://scontent.fsaw2-2.fna.fbcdn.net/v/t39.30808-1/244081837_10159808776148559_4464614354752744286_n.jpg?stp=cp0_dst-jpg_p80x80&_nc_cat=107&ccb=1-7&_nc_sid=5740b7&_nc_ohc=J3Uvo3OJdMAAX9MfA8i&_nc_ht=scontent.fsaw2-2.fna&oh=00_AfBRhp7eohE-9Txd5x86mrdFnjvbhOAwGBWVVpsoXDHIxQ&oe=65927491"} size={"40px"} />
                            </a>
                        </li>
                    </ul>
                </div>
