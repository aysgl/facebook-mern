          ...
          <div className="navbar-brand d-flex">
            ...
            <div className="form-wrapper">
              <span className="search">
                <svg viewBox="0 0 16 16" width="16" height="16" fill="#B1B3B9">
            ...
            <a
              className="sidebar ms-4 d-flex align-items-center"
              type="button"
            ...
            >
              <svg viewBox="0 0 24 24" width="24" height="24" fill="#B1B3B9">
